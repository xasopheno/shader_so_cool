...
use crate::renderable::SamplerConfig;
// use crate::shared::helpers::new_clear_color;
// use crate::shared::new_random_clear_color;

use self::render_pipeline::create_sampler_render_pipeline;
use self::vertex::SamplerVertex;

pub struct Sampler {
    pub vertices: Vec<SamplerVertex>,
    pub vertex_buffer: wgpu::Buffer,
    pub index_buffer: wgpu::Buffer,
    pub num_indices: u32,
    pub num_vertices: u32,
    pub uniforms: crate::sampler::uniforms::SamplerUniforms,
...
impl Sampler {
    ...
    pub fn new_random_vertices(n: usize) -> Vec<SamplerVertex> {
        (0..n)
            .into_iter()
            .map(|_| SamplerVertex::new_random())
            .collect()
    }
    ...
    pub fn init(
        ...
        let uniforms = crate::sampler::uniforms::SamplerUniforms::new();
        ...
        let render_pipeline =
            create_sampler_render_pipeline(device, &shader, &uniform_bind_group_layout, format);
